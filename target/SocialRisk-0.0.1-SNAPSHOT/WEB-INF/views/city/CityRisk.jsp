            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered table-striped"  width="800px">
                        ...
                        <tr>
                            <td>城市名称</td>
                            <td><input  class="form-control" placeholder="城市名称" value="${oneCityinfoById.name}" name="name">  </td>
                        </tr>
                        <tr>
                            <td>风险得分</td>
                            <td><input  class="form-control" placeholder="风险得分" value="${oneCityinfoById.riskscore}" name="riskscore">  </td>
                        </tr>
                        <div >
                            <c:if test="${oneCityinfoById.riskscore>=80}">
                                <p style="text-align: center">        <img src="http://localhost:8080//SocialRisk/green.jpg" height="150" width="150">       </p>
                            </c:if>
                            <c:if test="${oneCityinfoById.riskscore>=60&&oneCityinfoById.riskscore<80}">
                                <p style="text-align: center">        <img src="http://localhost:8080//SocialRisk/yellow.jpg" height="150" width="150">       </p>
                            </c:if>
                            <c:if test="${oneCityinfoById.riskscore<60}">
                                <p style="text-align: center">        <img src="http://localhost:8080//SocialRisk/red.jpg" height="150" width="150">       </p>
                            </c:if>
                        </div>
                        </tbody>
                    </table>
