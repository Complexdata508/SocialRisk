								  ...
								  <c:forEach items="${cityList}" var="City" varStatus="id">
			                          <tr >
										  ...
										  <td class="text-center">
											  <a type="button" class="btn bg-olive btn-xs " href="seleteCityRisk/${cityList.get(id.index).id}.shtml">查询风险</a>
										  </td>
		                                  <td class="text-center">
		                                 	  <a type="button" class="btn bg-olive btn-xs " href="toCityInfo/${cityList.get(id.index).id}.shtml" >修改</a>
											  <a type="button" class="btn bg-primary btn-xs"  href="toCityInfochakan/${cityList.get(id.index).id}.shtml" >详情</a>
										  </td>
			                          </tr>
								  </c:forEach>
			                      </tbody>
